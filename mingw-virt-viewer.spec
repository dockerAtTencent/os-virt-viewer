...
cp build_win32$MINGW_BUILDDIR_SUFFIX/data/virt-viewer-x86-0.5.7.msi $RPM_BUILD_ROOT/%{mingw32_datadir}/virt-viewer
%endif

%if 0%{?mingw_build_win64} == 1
cp build_win64$MINGW_BUILDDIR_SUFFIX/data/virt-viewer-x64-0.5.7.msi $RPM_BUILD_ROOT/%{mingw64_datadir}/virt-viewer
%endif
...
%{mingw32_datadir}/virt-viewer/virt-viewer-x86-0.5.7.msi
...
%{mingw64_datadir}/virt-viewer/virt-viewer-x64-0.5.7.msi
