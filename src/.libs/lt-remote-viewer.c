...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /usr/x86_64-w64-mingw32/sys-root/mingw/lib/libjansson.la /u", f);
  fputs ("sr/x86_64-w64-mingw32/sys-root/mingw/lib/libspice-client-gtk-2.0.la /usr/x86_64", f);
  fputs ("-w64-mingw32/sys-root/mingw/lib/libspice-client-glib-2.0.la /usr/x86_64-w64-min", f);
  fputs ("gw32/sys-root/mingw/lib/libusbredirhost.la /usr/x86_64-w64-mingw32/sys-root/min", f);
  fputs ("gw/lib/libusbredirparser.la /usr/x86_64-w64-mingw32/sys-root/mingw/lib/libspice", f);
  fputs ("-controller.la'\n", f);
  fputs ("else\n", f);
